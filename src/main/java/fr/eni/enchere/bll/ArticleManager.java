...
public interface ArticleManager {
	...
	public Article vendreArticle(String nomArticle, String description, LocalDate dateDebutEncheres,LocalDate dateFinEncheres, Integer prixInitial, Categorie categorie) throws BLLException;
